...
int main (int argc, char** argv)
{
    ...
    pass_new.setFilterLimits (-1.8, -1.2);
    ...
    for(int n=0; n<num_slices; n++){
	    ...
	    //cout << "Cloud sliced and nans removed" << endl;
	    ...
	    //cout << "just filterFunctioned" << endl;
